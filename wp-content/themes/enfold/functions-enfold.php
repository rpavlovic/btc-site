...
if(!function_exists('avia_title'))
{
	function avia_title($args = false, $id = false)
	{
		...
		$defaults 	 = array(
			...
			'html'			=> "<div class='{class} title_container'><div class='container'><{heading} class='main-title entry-title'></{heading}>{additions}</div></div>", //"<div class='{class} title_container'><div class='container'><{heading} class='main-title entry-title'>{title}</{heading}>{additions}</div></div>",
