...
?>
							...
							<div class="row">
								...
								<input type="radio" name="display_email" id="display_email_no" value="false"<?= $current_user->display_email == 'false' ? ' checked="checked"' : '' ?>>
								<label for="display_email_no">Don't display my address in my forum profile</label>
							</div>
