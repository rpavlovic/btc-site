 ...
 */
function btc_edit_user_avatar( $profileuser ) {
	$avatars = new Simple_Local_Avatars;
?>
							<div class="row">
								<label for="simple-local-avatar"><?php _e('Upload Avatar','simple-local-avatars'); ?></label>
								<div class="col" id="simple-local-avatar-photo">
									<?php
								...
								<?php
									if ( ! $upload_rights = current_user_can('upload_files') )
										$upload_rights = empty( $avatars->options['caps'] );
							...
							<div class="row">
								...
								<fieldset id="simple-local-avatar-ratings" <?php disabled( empty( $profileuser->simple_local_avatar ) ); ?>>
									...
									<?php
										if ( empty( $profileuser->simple_local_avatar_rating ) || ! array_key_exists( $profileuser->simple_local_avatar_rating, $avatars->avatar_ratings ) )
											$profileuser->simple_local_avatar_rating =  'G';

										foreach ( $avatars->avatar_ratings as $key => $rating ) :
